    ...
    <div class="flex items-center justify-between">
        <div>
            <div class="flex items-center gap-2">
                ...
                <h1 class="text-2xl font-bold text-gray-800">{{ __('Add Role') }}</h1>
            </div>
            <p class="text-sm text-gray-500 mt-1 ml-3">{{ __('Create a new role and assign permissions') }}</p>
        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateCount() {
        ...
        // Update each group's "Select All" text
