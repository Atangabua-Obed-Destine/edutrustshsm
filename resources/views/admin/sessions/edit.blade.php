...
@section('title', __('Edit Academic Session'))
@section('breadcrumb', __('Academic > Sessions > Edit'))

@section('content')
<div class="max-w-2xl">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h3 class="text-lg font-semibold text-gray-700 mb-6">{{ __('Edit Session') }}: {{ $session->name }}</h3>
